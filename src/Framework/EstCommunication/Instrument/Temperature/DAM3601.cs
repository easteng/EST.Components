...
// Type: EstCommunication.Instrument.Temperature.DAM3601
...
namespace EstCommunication.Instrument.Temperature
{
  ...
  public class DAM3601 : ModbusRtu
  {
    ...
    /// <example>
    /// 此处演示批量读取的示例
    /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="ReadExample2" title="Read示例" />
    /// </example>
