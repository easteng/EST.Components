...
// Type: EstCommunication.Language.DefaultLanguage
...
{
  /// <summary>系统的语言基类，默认也即是中文版本</summary>
  public class DefaultLanguage
  {
    ...
    public virtual string AuthorizationFailed => "系统授权失败，需要使用激活码授权，谢谢支持。设备激活数：" + Authorization.iahsduiwikaskfhishfdi.ToString();
