...
// Type: EstCommunication.Language.English
...
namespace EstCommunication.Language
{
  /// <summary>English Version Text</summary>
  public class English : DefaultLanguage
  {
    ...
    public override string AuthorizationFailed => "System authorization failed, need to use activation code authorization, thank you for your support. Active device number：" + Authorization.iahsduiwikaskfhishfdi.ToString();
    ...
    public override string Close => nameof (Close);
    ...
    public override string Send => nameof (Send);

    public override string Receive => nameof (Receive);
