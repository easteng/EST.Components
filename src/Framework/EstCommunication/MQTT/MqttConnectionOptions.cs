...
// Type: EstCommunication.MQTT.MqttConnectionOptions
...
{
  /// <summary>
  /// 连接MQTT服务器的一些参数信息，适用<see cref="T:EstCommunication.MQTT.MqttClient" />消息发布订阅客户端以及<see cref="T:EstCommunication.MQTT.MqttSyncClient" />同步请求客户端。<br />
  /// Some parameter information for connecting to the MQTT server is applicable to the <see cref="T:EstCommunication.MQTT.MqttClient" /> message publishing and subscription client and the <see cref="T:EstCommunication.MQTT.MqttSyncClient" /> synchronization request client.
  /// </summary>
