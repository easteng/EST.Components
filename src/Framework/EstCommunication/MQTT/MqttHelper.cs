...
// Type: EstCommunication.MQTT.MqttHelper
...
namespace EstCommunication.MQTT
{
  ...
  public class MqttHelper
  {
    ...
    /// <inheritdoc cref="M:EstCommunication.MQTT.MqttHelper.GetSyncServicesApiInformationFromObject(System.String,System.Object,EstCommunication.Reflection.EstMqttPermissionAttribute)" />
    ...
    /// <returns>返回所有API说明的列表，类型为<see cref="T:EstCommunication.MQTT.MqttRpcApiInfo" /></returns>
    public static List<MqttRpcApiInfo> GetSyncServicesApiInformationFromObject(
      string api,
      object obj,
    ...
    /// <summary>
    /// 根据当前的方法的委托信息和类对象，生成<see cref="T:EstCommunication.MQTT.MqttRpcApiInfo" />的API对象信息。
    /// </summary>
