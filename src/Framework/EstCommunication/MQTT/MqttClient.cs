...
// Type: EstCommunication.MQTT.MqttClient
...
namespace EstCommunication.MQTT
{
  ...
  /// </remarks>
  /// <example>
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test" title="简单的实例化" />
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test2" title="带用户名密码的实例化" />
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test3" title="连接示例" />
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test4" title="发布示例" />
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test5" title="订阅示例" />
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test8" title="网络重连示例" />
  /// </example>
  public class MqttClient : NetworkXBase
  {
    ...
    /// <inheritdoc cref="M:EstCommunication.MQTT.MqttClient.ConnectServer" />
    ...
    /// <inheritdoc cref="M:EstCommunication.MQTT.MqttClient.ConnectClose" />
    ...
    /// <example>
    /// 参照 <see cref="T:EstCommunication.MQTT.MqttClient" /> 的示例说明。
    /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test" title="简单的实例化" />
    /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test4" title="发布示例" />
    /// </example>
    ...
    /// <inheritdoc cref="M:EstCommunication.MQTT.MqttClient.PublishMessage(EstCommunication.MQTT.MqttApplicationMessage)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.MQTT.MqttClient.SubscribeMessage(System.String)" />
    ...
    /// 参照 <see cref="T:EstCommunication.MQTT.MqttClient" /> 的示例说明。
    /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test" title="简单的实例化" />
    /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\MQTT\MQTTClient.cs" region="Test7" title="订阅示例" />
    /// </example>
    ...
    /// <inheritdoc cref="M:EstCommunication.MQTT.MqttClient.UnSubscribeMessage(System.String[])" />
