...
// Type: EstCommunication.BasicFramework.SoftFileSaveBase
...
namespace EstCommunication.BasicFramework
{
  ...
  /// <example>
  /// 下面举例实现两个字段的普通数据存储
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\BasicFramework\SoftFileSaveBaseExample.cs" region="SoftFileSaveBase1" title="简单示例" />
  /// 然后怎么调用呢？
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\BasicFramework\SoftFileSaveBaseExample.cs" region="Example" title="调用示例" />
  /// 如果你想实现加密存储，这样就不用关心被用户看到了。
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\BasicFramework\SoftFileSaveBaseExample.cs" region="SoftFileSaveBase2" title="加密示例" />
  ...
  public class SoftFileSaveBase : ISoftFileSaveBase
  {
    ...
    /// <inheritdoc cref="M:EstCommunication.BasicFramework.ISoftFileSaveBase.ToSaveString" />
    public virtual string ToSaveString() => string.Empty;

    /// <inheritdoc cref="M:EstCommunication.BasicFramework.ISoftFileSaveBase.LoadByString(System.String)" />
    public virtual void LoadByString(string content)
    {
    }

    /// <inheritdoc cref="M:EstCommunication.BasicFramework.ISoftFileSaveBase.LoadByFile" />
    ...
    /// <inheritdoc cref="M:EstCommunication.BasicFramework.ISoftFileSaveBase.SaveToFile" />
