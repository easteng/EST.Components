...
// Type: EstCommunication.BasicFramework.SoftNumericalOrder
...
namespace EstCommunication.BasicFramework
{
  ...
  /// <code lang="cs" source="TestProject\EstCommunicationDemo\FormSeqCreate.cs" region="FormSeqCreate" title="示例代码" />
  /// </example>
