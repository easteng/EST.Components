...
// Type: EstCommunication.BasicFramework.SoftMail
...
namespace EstCommunication.BasicFramework
{
  ...
  /// <code lang="cs" source="TestProject\EstCommunicationDemo\FormMail.cs" region="SoftMail" title="SoftMail示例" />
  /// </example>
  public class SoftMail
  {
    ...
    /// <example>
    /// <code lang="cs" source="EstCommunication_Net45\BasicFramework\SoftMail.cs" region="Static Mail" title="SoftMail示例" />
    /// </example>
