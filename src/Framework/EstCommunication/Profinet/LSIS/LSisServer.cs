...
// Type: EstCommunication.Profinet.LSIS.LSisServer
...
using EstCommunication.Profinet.Panasonic;
...
namespace EstCommunication.Profinet.LSIS
{
  ...
  public class LSisServer : NetworkDataServerBase
  {
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.LSIS.XGBFastEnet.Read(System.String,System.UInt16)" />
