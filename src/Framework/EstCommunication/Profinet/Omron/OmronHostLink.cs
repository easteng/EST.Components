...
// Type: EstCommunication.Profinet.Omron.OmronHostLink
...
namespace EstCommunication.Profinet.Omron
{
  ...
  /// </remarks>
  /// <example>
  /// <inheritdoc cref="T:EstCommunication.Profinet.Omron.OmronHostLinkOverTcp" path="example" />
  /// </example>
  public class OmronHostLink : SerialDeviceBase
  {
    ...
    /// <inheritdoc cref="P:EstCommunication.Profinet.Omron.OmronHostLinkOverTcp.ICF" />
    public byte ICF { get; set; } = 0;

    /// <inheritdoc cref="P:EstCommunication.Profinet.Omron.OmronHostLinkOverTcp.DA2" />
    public byte DA2 { get; set; } = 0;

    /// <inheritdoc cref="P:EstCommunication.Profinet.Omron.OmronHostLinkOverTcp.SA2" />
    public byte SA2 { get; set; }

    /// <inheritdoc cref="P:EstCommunication.Profinet.Omron.OmronHostLinkOverTcp.SID" />
    public byte SID { get; set; } = 0;

    /// <inheritdoc cref="P:EstCommunication.Profinet.Omron.OmronHostLinkOverTcp.ResponseWaitTime" />
    public byte ResponseWaitTime { get; set; } = 48;

    /// <inheritdoc cref="P:EstCommunication.Profinet.Omron.OmronHostLinkOverTcp.UnitNumber" />
