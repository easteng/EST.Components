...
// Type: EstCommunication.Profinet.FATEK.FatekProgram
...
namespace EstCommunication.Profinet.FATEK
{
  ...
  /// </summary>
  /// <remarks>
  /// <inheritdoc cref="T:EstCommunication.Profinet.FATEK.FatekProgramOverTcp" path="remarks" />
  /// </remarks>
  /// <example>
  /// <inheritdoc cref="T:EstCommunication.Profinet.FATEK.FatekProgramOverTcp" path="example" />
  /// </example>
  public class FatekProgram : SerialDeviceBase
  {
    private byte station = 1;

    /// <inheritdoc cref="M:EstCommunication.Profinet.FATEK.FatekProgramOverTcp.#ctor" />
    public FatekProgram()
    {
    ...
    /// <inheritdoc cref="P:EstCommunication.Profinet.FATEK.FatekProgramOverTcp.Station" />
    public byte Station
    {
      get => this.station;
