...
// Type: EstCommunication.Profinet.GE.GeSRTPNet
...
namespace EstCommunication.Profinet.GE
{
  ...
  ///   </item>
  /// </list>
  /// <note type="important">对于 AI,AQ,R 类型的数据来说，底层是以字为单位的，但是调用 <see cref="M:EstCommunication.Profinet.GE.GeSRTPNet.Read(System.String,System.UInt16)" /> 来读取原始数据时，需要传入2被的字长度，对于其他方法不影响</note>
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\Profinet\GeSRTPNetSample.cs" region="Usage" title="简单的短连接使用" />
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\Profinet\GeSRTPNetSample.cs" region="Usage2" title="简单的长连接使用" />
  /// 
  /// 假设起始地址为R1，R1存储了温度，100.6℃值为1006，R2存储了压力，1.23Mpa值为123，R3-R4存储了产量计数，读取如下：
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\Profinet\GeSRTPNetSample.cs" region="ReadExample2" title="Read示例" />
  /// 以下是读取不同类型数据的示例
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\Profinet\GeSRTPNetSample.cs" region="ReadExample1" title="Read示例" />
  /// </example>
  public class GeSRTPNet : NetworkDeviceBase
  {
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.GE.GeSRTPNet.Read(System.String,System.UInt16)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.GE.GeSRTPNet.Write(System.String,System.Byte[])" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.GE.GeSRTPNet.ReadByte(System.String)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.GE.GeSRTPNet.ReadBool(System.String,System.UInt16)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.GE.GeSRTPNet.Write(System.String,System.Boolean[])" />
    public override async Task<OperateResult> WriteAsync(
      string address,
      bool[] value)
    {
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.GE.GeSRTPNet.ReadPLCTime" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.GE.GeSRTPNet.ReadProgramName" />
