...
// Type: EstCommunication.Profinet.GE.GeSRTPServer
...
namespace EstCommunication.Profinet.GE
{
  ...
  /// </summary>
  /// <remarks>
  /// 实例化之后，直接调用 <see cref="M:EstCommunication.Core.Net.NetworkServerBase.ServerStart(System.Int32)" /> 方法就可以通信及交互，所有的地址都是从1开始的，地址示例：M1,M100, R1，
  /// 具体的用法参考 EstCommunicationDemo 相关界面的源代码。
  /// </remarks>
  /// <example>
  /// 地址的示例，参考 <see cref="T:EstCommunication.Profinet.GE.GeSRTPNet" /> 相关的示例说明
  /// </example>
