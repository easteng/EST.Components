...
// Type: EstCommunication.Profinet.Keyence.KeyenceMcNet
...
namespace EstCommunication.Profinet.Keyence
{
  ...
  public class KeyenceMcNet : MelsecMcNet
  {
    ...
    /// <inheritdoc />
    public override string ToString() => string.Format("KeyenceMcNet[{0}:{1}]", (object) this.IpAddress, (object) this.Port);
  }
}
