...
// Type: EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet
...
namespace EstCommunication.Profinet.Beckhoff
{
  ...
  /// <br />
  /// <note type="important">
  /// 在实际的测试中，由于打开了VS软件对倍福PLC进行编程操作，会导致EstCommunicationDemo读取PLC发生间歇性读写失败的问题，此时需要关闭Visual Studio软件对倍福的
  /// 连接，之后EstCommunicationDemo就会读写成功，感谢QQ：1813782515 提供的解决思路。
  /// </note>
  /// </remarks>
  public class BeckhoffAdsNet : NetworkDeviceBase
  {
    ...
    /// <summary>
    /// 读取Ads设备的状态信息，其中<see cref="P:EstCommunication.OperateResult`2.Content1" />是Ads State，<see cref="P:EstCommunication.OperateResult`2.Content2" />是Device State<br />
    /// Read the status information of the Ads device, where <see cref="P:EstCommunication.OperateResult`2.Content1" /> is the Ads State, and <see cref="P:EstCommunication.OperateResult`2.Content2" /> is the Device State
    /// </summary>
    ...
    /// <summary>
    /// 释放当前的系统句柄，该句柄是通过<see cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.ReadValueHandle(System.String)" />获取的
    /// </summary>
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.ReadValueHandle(System.String)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.TransValueHandle(System.String)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.ReadAdsDeviceInfo" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.ReadAdsState" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.WriteAdsState(System.Int16,System.Int16,System.Byte[])" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.ReleaseSystemHandle(System.UInt32)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.Read(System.String,System.UInt16)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.Write(System.String,System.Byte[])" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.ReadBool(System.String,System.UInt16)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.Write(System.String,System.Boolean[])" />
    public override async Task<OperateResult> WriteAsync(
      string address,
      bool[] value)
    {
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Beckhoff.BeckhoffAdsNet.ReadByte(System.String)" />
