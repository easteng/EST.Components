...
// Type: EstCommunication.Profinet.Melsec.MelsecMcNet
...
namespace EstCommunication.Profinet.Melsec
{
  ...
  /// <item>[商业授权] 基于标签的地址: 表示位 s=AAA  假如标签的名称为AAA，但是标签的读取是有条件的，详细参照<see cref="M:EstCommunication.Profinet.Melsec.MelsecMcNet.ReadTags(System.String,System.UInt16)" /></item>
  ...
  public class MelsecMcNet : NetworkDeviceBase
  {
    ...
    /// </remarks>
    /// <example>
    /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\Profinet\melsecTest.cs" region="ReadExample3" title="随机字读取示例" /></example>
    /// <returns>结果</returns>
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Melsec.MelsecMcNet.ReadBool(System.String,System.UInt16)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Melsec.MelsecMcNet.Write(System.String,System.Boolean[])" />
    public override async Task<OperateResult> WriteAsync(
      string address,
      bool[] values)
    {
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Melsec.MelsecMcNet.ReadTags(System.String,System.UInt16)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.Profinet.Melsec.MelsecMcNet.ReadExtend(System.UInt16,System.String,System.UInt16)" />
