...
// Type: EstCommunication.Core.IMessage.YokogawaLinkBinaryMessage
...
{
  /// <summary>横河PLC的以太网的二进制协议</summary>
  public class YokogawaLinkBinaryMessage : INetMessage
  {
    ...
    public int GetContentLengthByHeadBytes() => (int) this.HeadBytes[2] * 256 + (int) this.HeadBytes[3];
