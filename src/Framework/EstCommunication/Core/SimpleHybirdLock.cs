...
// Type: EstCommunication.Core.SimpleHybirdLock
...
namespace EstCommunication.Core
{
  ...
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\Core\ThreadLock.cs" region="SimpleHybirdLockExample1" title="SimpleHybirdLock示例" />
  /// </example>
