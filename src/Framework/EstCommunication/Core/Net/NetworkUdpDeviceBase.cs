...
// Type: EstCommunication.Core.Net.NetworkUdpDeviceBase
...
namespace EstCommunication.Core.Net
{
  ...
  public class NetworkUdpDeviceBase : NetworkUdpBase, IReadWriteNet
  {
    ...
    /// <inheritdoc />
    public override string ToString() => string.Format("NetworkUdpDeviceBase<{0}>[{1}:{2}]", (object) this.ByteTransform.GetType(), (object) this.IpAddress, (object) this.Port);
