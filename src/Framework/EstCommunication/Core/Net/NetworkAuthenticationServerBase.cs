...
// Type: EstCommunication.Core.Net.NetworkAuthenticationServerBase
...
namespace EstCommunication.Core.Net
{
  ...
  public class NetworkAuthenticationServerBase : NetworkServerBase, IDisposable
  {
    ...
    /// <summary>
    /// 新增账户，如果想要启动账户登录，必须将<see cref="P:EstCommunication.Core.Net.NetworkAuthenticationServerBase.IsUseAccountCertificate" />设置为<c>True</c>。<br />
    /// Add an account. If you want to activate account login, you must set <see cref="P:EstCommunication.Core.Net.NetworkAuthenticationServerBase.IsUseAccountCertificate" /> to <c> True </c>
    /// </summary>
