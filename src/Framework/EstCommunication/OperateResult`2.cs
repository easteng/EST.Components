...
// Type: EstCommunication.OperateResult`2
...
{
  /// <summary>操作结果的泛型类，允许带两个用户自定义的泛型对象，推荐使用这个类</summary>
  ...
  public class OperateResult<T1, T2> : OperateResult
  {
    ...
    public OperateResult<T1, T2> Check(Func<T1, T2, bool> check, string message = "All content data check failed") => !this.IsSuccess || check(this.Content1, this.Content2) ? this : new OperateResult<T1, T2>(message);
    ...
    public OperateResult<T1, T2> Check(Func<T1, T2, OperateResult> check)
    {
      ...
      return !result.IsSuccess ? OperateResult.CreateFailedResult<T1, T2>(result) : this;
    }
    ...
    public OperateResult Then(Func<T1, T2, OperateResult> func) => !this.IsSuccess ? (OperateResult) this : func(this.Content1, this.Content2);
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9>((OperateResult) this) : func(this.Content1, this.Content2);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9, TResult10>((OperateResult) this) : func(this.Content1, this.Content2);
    }
  }
}
