...
// Type: EstCommunication.Algorithms.ConnectPool.IConnector
...
namespace EstCommunication.Algorithms.ConnectPool
{
  ...
  /// <remarks>为了使用完整的连接池功能，需要先实现本接口，然后配合<see cref="T:EstCommunication.Algorithms.ConnectPool.ConnectPool`1" />来使用</remarks>
  /// <example>
