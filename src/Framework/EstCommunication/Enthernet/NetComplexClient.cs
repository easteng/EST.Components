...
// Type: EstCommunication.Enthernet.NetComplexClient
...
namespace EstCommunication.Enthernet
{
  ...
  /// <code lang="cs" source="TestProject\EstCommunicationDemo\Est\FormComplexNet.cs" region="NetComplexClient" title="NetComplexClient示例" />
  /// </example>
