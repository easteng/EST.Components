...
// Type: EstCommunication.ModBus.ModbusTcpServer
...
namespace EstCommunication.ModBus
{
  ...
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\Modbus\ModbusTcpServer.cs" region="ModbusTcpServerExample" title="ModbusTcpServer示例" />
  /// </example>
  public class ModbusTcpServer : NetworkDataServerBase
  {
    ...
    public void StartModbusRtu(string com, int baudRate) => this.StartModbusRtu((Action<SerialPort>) (sp =>
    {
      sp.PortName = com;
