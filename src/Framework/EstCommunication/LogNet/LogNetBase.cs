...
// Type: EstCommunication.LogNet.LogNetBase
...
namespace EstCommunication.LogNet
{
  ...
  /// <list type="number">
  /// <item>单文件日志类 <see cref="T:EstCommunication.LogNet.LogNetSingle" /></item>
  /// <item>根据文件大小的类 <see cref="T:EstCommunication.LogNet.LogNetFileSize" /></item>
  /// <item>根据时间进行存储的类 <see cref="T:EstCommunication.LogNet.LogNetDateTime" /></item>
  /// </list>
  /// </remarks>
  public abstract class LogNetBase : IDisposable
  {
    ...
    /// <inheritdoc cref="E:EstCommunication.LogNet.ILogNet.BeforeSaveToFile" />
    ...
    /// <inheritdoc cref="P:EstCommunication.LogNet.ILogNet.LogSaveMode" />
    public LogSaveMode LogSaveMode { get; protected set; }

    /// <inheritdoc cref="P:EstCommunication.LogNet.ILogNet.LogNetStatistics" />
    public LogStatistics LogNetStatistics { get; set; }

    /// <inheritdoc cref="P:EstCommunication.LogNet.ILogNet.ConsoleOutput" />
    public bool ConsoleOutput { get; set; }

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteDebug(System.String)" />
    [EstMqttApi]
    public void WriteDebug(string text) => this.WriteDebug(string.Empty, text);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteDebug(System.String,System.String)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteInfo(System.String)" />
    [EstMqttApi]
    public void WriteInfo(string text) => this.WriteInfo(string.Empty, text);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteInfo(System.String,System.String)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteWarn(System.String)" />
    [EstMqttApi]
    public void WriteWarn(string text) => this.WriteWarn(string.Empty, text);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteWarn(System.String,System.String)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteError(System.String)" />
    [EstMqttApi]
    public void WriteError(string text) => this.WriteError(string.Empty, text);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteError(System.String,System.String)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteFatal(System.String)" />
    [EstMqttApi]
    public void WriteFatal(string text) => this.WriteFatal(string.Empty, text);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteFatal(System.String,System.String)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteException(System.String,System.Exception)" />
    public void WriteException(string keyWord, Exception ex) => this.WriteException(keyWord, string.Empty, ex);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteException(System.String,System.String,System.Exception)" />
    ...
    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.RecordMessage(EstCommunication.LogNet.EstMessageDegree,System.String,System.String)" />
    public void RecordMessage(EstMessageDegree degree, string keyWord, string text) => this.WriteToFile(degree, keyWord, text);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteDescrition(System.String)" />
    [EstMqttApi]
    ...
    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteAnyString(System.String)" />
    [EstMqttApi]
    public void WriteAnyString(string text) => this.RecordMessage(EstMessageDegree.None, string.Empty, text);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.WriteNewLine" />
    [EstMqttApi]
    public void WriteNewLine() => this.RecordMessage(EstMessageDegree.None, string.Empty, "\x0002" + Environment.NewLine);

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.SetMessageDegree(EstCommunication.LogNet.EstMessageDegree)" />
    public void SetMessageDegree(EstMessageDegree degree) => this.m_messageDegree = degree;

    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.FiltrateKeyword(System.String)" />
    [EstMqttApi]
    ...
    /// <inheritdoc cref="M:EstCommunication.LogNet.ILogNet.RemoveFiltrate(System.String)" />
    [EstMqttApi]
