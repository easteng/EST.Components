...
// Type: EstCommunication.OperateResult`6
...
{
  /// <summary>操作结果的泛型类，允许带六个用户自定义的泛型对象，推荐使用这个类</summary>
  ...
  public class OperateResult<T1, T2, T3, T4, T5, T6> : OperateResult
  {
    ...
    public OperateResult<T1, T2, T3, T4, T5, T6> Check(
      Func<T1, T2, T3, T4, T5, T6, bool> check,
      string message = "All content data check failed")
    {
      return !this.IsSuccess || check(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6) ? this : new OperateResult<T1, T2, T3, T4, T5, T6>(message);
    }
    ...
    /// <returns>如果检查成功，则返回对象本身，如果失败，返回错误信息。</returns>
    public OperateResult<T1, T2, T3, T4, T5, T6> Check(
      Func<T1, T2, T3, T4, T5, T6, OperateResult> check)
    {
      if (!this.IsSuccess)
        return this;
      OperateResult result = check(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
      return !result.IsSuccess ? OperateResult.CreateFailedResult<T1, T2, T3, T4, T5, T6>(result) : this;
    }
    ...
    public OperateResult Then(Func<T1, T2, T3, T4, T5, T6, OperateResult> func) => !this.IsSuccess ? (OperateResult) this : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
    ...
    {
      return !this.IsSuccess ? OperateResult.CreateFailedResult<TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8, TResult9, TResult10>((OperateResult) this) : func(this.Content1, this.Content2, this.Content3, this.Content4, this.Content5, this.Content6);
    }
  }
}
