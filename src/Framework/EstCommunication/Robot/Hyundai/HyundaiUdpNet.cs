...
// Type: EstCommunication.Robot.Hyundai.HyundaiUdpNet
...
namespace EstCommunication.Robot.Hyundai
{
  ...
  public class HyundaiUdpNet : NetworkUdpServerBase
  {
    ...
    /// <summary>
    /// 将指定的命令写入机器人，该命令是完全自定义的，需要遵循机器人的通讯协议，在写入之前，需要调用<see cref="M:EstCommunication.Core.Net.NetworkUdpServerBase.ServerStart(System.Int32)" /> 方法<br />
    ...
    /// Before writing, you need to call the <see cref="M:EstCommunication.Core.Net.NetworkUdpServerBase.ServerStart(System.Int32)" />
    /// </summary>
