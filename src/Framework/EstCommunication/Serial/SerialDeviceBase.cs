...
// Type: EstCommunication.Serial.SerialDeviceBase
...
{
  /// <summary>
  /// 串口设备交互类的基类，实现了<see cref="T:EstCommunication.Core.IReadWriteNet" />接口的基础方法方法，需要使用继承重写来实现字节读写，bool读写操作。<br />
  /// The base class of the serial device interaction class, which implements the basic methods of the <see cref="T:EstCommunication.Core.IReadWriteNet" /> interface,
  ...
  /// <list type="number">
  /// <item>
  /// <see cref="M:EstCommunication.Serial.SerialDeviceBase.Read(System.String,System.UInt16)" /> 方法，读取字节数组的方法。
  /// </item>
  /// <item>
  /// <see cref="M:EstCommunication.Serial.SerialDeviceBase.Write(System.String,System.Byte[])" /> 方法，写入字节数组的方法。
  /// </item>
  /// <item>
  /// <see cref="M:EstCommunication.Serial.SerialDeviceBase.ReadBool(System.String,System.UInt16)" /> 方法，读取bool数组的方法。
  /// </item>
  /// <item>
  /// <see cref="M:EstCommunication.Serial.SerialDeviceBase.Write(System.String,System.Boolean[])" /> 方法，写入bool数组的方法。
  /// </item>
  /// </list>
  /// 如果需要实现异步的方法。那就需要重写下面的四个方法。
  /// <list type="number">
  /// <item>
  /// <see cref="M:EstCommunication.Serial.SerialDeviceBase.ReadAsync(System.String,System.UInt16)" /> 方法，读取字节数组的方法。
  /// </item>
  /// <item>
  /// <see cref="M:EstCommunication.Serial.SerialDeviceBase.WriteAsync(System.String,System.Byte[])" /> 方法，写入字节数组的方法。
  /// </item>
  /// <item>
  /// <see cref="M:EstCommunication.Serial.SerialDeviceBase.ReadBoolAsync(System.String,System.UInt16)" /> 方法，读取bool数组的方法。
  /// </item>
  /// <item>
  /// <see cref="M:EstCommunication.Serial.SerialDeviceBase.WriteAsync(System.String,System.Boolean[])" /> 方法，写入bool数组的方法。
  /// </item>
  /// </list>
  /// </remarks>
  public class SerialDeviceBase : SerialBase, IReadWriteNet
  {
    ...
    /// <inheritdoc cref="P:EstCommunication.Core.Net.NetworkDeviceBase.WordLength" />
