...
// Type: EstCommunication.WebSocket.WebSocketClient
...
namespace EstCommunication.WebSocket
{
  ...
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\WebSocket\WebSocketClientSample.cs" region="Sample1" title="简单的实例化" />
  /// 假设我们需要发数据给服务端，那么可以参考如下的方式
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\WebSocket\WebSocketClientSample.cs" region="Sample2" title="发送数据" />
  /// 如果我们需要搭配服务器来做订阅推送的功能的话，写法上会稍微有点区别，按照下面的代码来写。
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\WebSocket\WebSocketClientSample.cs" region="Sample3" title="订阅操作" />
  /// 当网络发生异常的时候，我们需要这么来进行重新连接。
  /// <code lang="cs" source="EstCommunication_Net45.Test\Documentation\Samples\WebSocket\WebSocketClientSample.cs" region="Sample4" title="异常重连" />
  /// </example>
  public class WebSocketClient : NetworkXBase
  {
    ...
    /// <inheritdoc cref="M:EstCommunication.WebSocket.WebSocketClient.ConnectServer" />
    ...
    /// <inheritdoc cref="M:EstCommunication.WebSocket.WebSocketClient.ConnectServer(System.String[])" />
    ...
    /// <inheritdoc cref="M:EstCommunication.WebSocket.WebSocketClient.ConnectClose" />
