...
// Type: ESTCore.Common.Profinet.Siemens.SiemensPPI
...
namespace ESTCore.Common.Profinet.Siemens
{
    ...
    /// 在本类的<see cref="T:ESTCore.Common.Profinet.Siemens.SiemensPPIOverTcp" />实现类里，如果使用了Async的异步方法，没有增加同步锁，多线程调用可能会引发数据错乱的情况。<br />
    /// In the <see cref="T:ESTCore.Common.Profinet.Siemens.SiemensPPIOverTcp" /> implementation class of this class, if the asynchronous method of Async is used,
