...
// Type: ESTCore.Common.Profinet.Keyence.KeyenceNanoServer
...
namespace ESTCore.Common.Profinet.Keyence
{
    ...
    public class KeyenceNanoServer : NetworkDataServerBase
    {
        ...
        /// <summary>
        /// 实例化一个基于上位链路协议的虚拟的基恩士PLC对象，可以用来和<see cref="T:ESTCore.Common.Profinet.Keyence.KeyenceNanoSerialOverTcp" />进行通信测试。
        /// </summary>
