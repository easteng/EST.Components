...
// Type: ESTCore.Common.Profinet.IDCard.SAMTcpNet
...
namespace ESTCore.Common.Profinet.IDCard
{
    ...
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Profinet\SAMSerialSample.cs" region="Sample3" title="实例化操作" />
    /// 在实际的读取，我们一般放在后台进行循环扫描的操作，参见下面的代码
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Profinet\SAMSerialSample.cs" region="Sample4" title="基本的读取操作" />
    /// 当然也支持全异步的操作了，就是方法的名称改改
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Profinet\SAMSerialSample.cs" region="Sample5" title="实例化操作" />
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Profinet\SAMSerialSample.cs" region="Sample6" title="基本的读取操作" />
    /// </example>
