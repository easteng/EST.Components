...
// Type: ESTCore.Common.Profinet.Omron.OmronFinsUdp
...
{
    /// <summary>
    /// 欧姆龙的Udp协议的实现类，地址类型和Fins-TCP一致，无连接的实现，可靠性不如<see cref="T:ESTCore.Common.Profinet.Omron.OmronFinsNet" /><br />
    /// Omron's Udp protocol implementation class, the address type is the same as Fins-TCP,
    /// and the connectionless implementation is not as reliable as <see cref="T:ESTCore.Common.Profinet.Omron.OmronFinsNet" />
    /// </summary>
    /// <remarks>
    /// <inheritdoc cref="T:ESTCore.Common.Profinet.Omron.OmronFinsNet" path="remarks" />
    /// </remarks>
    public class OmronFinsUdp : NetworkUdpDeviceBase
    {
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Omron.OmronFinsNet.#ctor(System.String,System.Int32)" />
        ...
        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.ICF" />
        public byte ICF { get; set; } = 128;

        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.RSV" />
        public byte RSV { get; private set; } = 0;

        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.GCT" />
        public byte GCT { get; set; } = 2;

        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.DNA" />
        public byte DNA { get; set; } = 0;

        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.DA1" />
        public byte DA1 { get; set; } = 19;

        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.DA2" />
        public byte DA2 { get; set; } = 0;

        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.SNA" />
        public byte SNA { get; set; } = 0;

        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.SA1" />
        ...
        /// <inheritdoc cref="P:ESTCore.Common.Profinet.Omron.OmronFinsNet.ReadSplits" />
        public int ReadSplits { get; set; } = 500;

        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Omron.OmronFinsNet.PackCommand(System.Byte[])" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Omron.OmronFinsNet.BuildReadCommand(System.String,System.UInt16,System.Boolean)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Omron.OmronFinsNet.BuildWriteCommand(System.String,System.Byte[],System.Boolean)" />
