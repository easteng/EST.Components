...
// Type: ESTCore.Common.Profinet.Omron.OmronCipNet
...
namespace ESTCore.Common.Profinet.Omron
{
    ...
    public class OmronCipNet : AllenBradleyNet
    {
      ...
      (byte) 0
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Omron.OmronCipNet.Read(System.String,System.UInt16)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Omron.OmronCipNet.Write(System.String,System.Byte)" />
        public override async Task<OperateResult> WriteAsync(
          string address,
          byte value)
        {
