...
// Type: ESTCore.Common.Profinet.Melsec.MelsecA1ENet
...
namespace ESTCore.Common.Profinet.Melsec
{
    ...
    ///   </item>
    /// </list>
    /// <see cref="M:ESTCore.Common.Profinet.Melsec.MelsecA1ENet.ReadBool(System.String,System.UInt16)" /> 方法一次读取的最多点数是256点。
