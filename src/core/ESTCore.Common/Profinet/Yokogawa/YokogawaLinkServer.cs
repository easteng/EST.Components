...
// Type: ESTCore.Common.Profinet.Yokogawa.YokogawaLinkServer
...
namespace ESTCore.Common.Profinet.Yokogawa
{
    ...
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Profinet\YokogawaLinkServerSample.cs" region="UseExample1" title="简单的创建服务器" />
    /// 当然如果需要高级的服务器，指定日志，限制客户端的IP地址，获取客户端发送的信息，在服务器初始化的时候就要参照下面的代码：
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Profinet\YokogawaLinkServerSample.cs" region="UseExample4" title="定制服务器" />
    /// 服务器创建好之后，我们就可以对服务器进行一些读写的操作了，下面的代码是基础的BCL类型的读写操作。
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Profinet\YokogawaLinkServerSample.cs" region="ReadWriteExample" title="基础的读写示例" />
    /// 高级的对于byte数组类型的数据进行批量化的读写操作如下：
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Profinet\YokogawaLinkServerSample.cs" region="BytesReadWrite" title="字节的读写示例" />
    /// 更高级操作请参见源代码。
    /// </example>
    public class YokogawaLinkServer : NetworkDataServerBase
    {
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Yokogawa.YokogawaLinkTcp.Read(System.String,System.UInt16)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Yokogawa.YokogawaLinkTcp.Write(System.String,System.Byte[])" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Yokogawa.YokogawaLinkTcp.ReadBool(System.String,System.UInt16)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Profinet.Yokogawa.YokogawaLinkTcp.Write(System.String,System.Boolean[])" />
