...
// Type: ESTCore.Common.Profinet.Yokogawa.YokogawaSystemInfo
...
namespace ESTCore.Common.Profinet.Yokogawa
{
    ...
    public class YokogawaSystemInfo
    {
        ...
        /// <summary>
        /// 根据原始的数据信息解析出<see cref="T:ESTCore.Common.Profinet.Yokogawa.YokogawaSystemInfo" />对象<br />
        /// Analyze the <see cref="T:ESTCore.Common.Profinet.Yokogawa.YokogawaSystemInfo" /> object according to the original data information
        /// </summary>
