...
// Type: ESTCore.Common.Enthernet.Redis.RedisClient
...
{
    /// <summary>
    /// 这是一个redis的客户端类，支持读取，写入，发布订阅，但是不支持订阅，如果需要订阅，请使用另一个类<see cref="T:ESTCore.Common.Enthernet.Redis.RedisSubscribe" />
    /// </summary>
    /// <remarks>本类库的API指令的参考及注释来源：http://doc.redisfans.com/index.html</remarks>
    /// <example>
    /// 基本的操作如下所示，举例了几个比较常见的指令，更多的需要参考api接口描述
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Enthernet\RedisSample.cs" region="SampleBasic" title="基本操作代码" />
    /// 如下是基于特性的操作，有必要说明以下：
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Enthernet\RedisSample.cs" region="Sample1" title="基础的使用" />
    /// 总的来说，当读取的数据种类比较多的时候，读取的关键字比较多的时候，处理起来就比较的麻烦，此处推荐一个全新的写法，为了更好的对比，我们假设实现一种需求
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Enthernet\RedisSample.cs" region="Sample2" title="同等代码" />
    /// 为此我们只需要实现一个特性类即可。代码如下：(注意，实际是很灵活的，类型都是自动转换的)
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Enthernet\RedisSample.cs" region="SampleClass" title="数据类" />
    /// </example>
    public class RedisClient : NetworkDoubleBase
    {
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.ReadCustomer(System.String)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.OperateNumberFromServer(System.String[])" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.OperateLongNumberFromServer(System.String[])" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.OperateStringFromServer(System.String[])" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.OperateStringsFromServer(System.String[])" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.OperateStatusFromServer(System.String[])" />
      ...
      member
        ...
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Enthernet\RedisSample.cs" region="Sample3" title="异步示例" />
        /// </example>
        ...
        /// <returns>包含是否成功的结果对象</returns>
        /// <example>
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.Read``1" path="example" />
        /// </example>
      ...
      topic
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.SubscribeMessage(System.String)" />
      ...
      topic
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Enthernet.Redis.RedisClient.UnSubscribeMessage(System.String)" />
