...
// Type: ESTCore.Common.Enthernet.NetPushClient
...
namespace ESTCore.Common.Enthernet
{
    ...
    /// <code lang="cs" source="TestProject\ESTCore.CommonDemo\Est\FormPushNet.cs" region="FormPushNet" title="NetPushClient示例" />
    /// </example>
