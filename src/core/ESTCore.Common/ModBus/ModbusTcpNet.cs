...
// Type: ESTCore.Common.ModBus.ModbusTcpNet
...
namespace ESTCore.Common.ModBus
{
    ...
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="Sample1" title="序号示例" />
    /// <note type="important">
    ...
    /// </list>
    /// 基本的用法请参照下面的代码示例
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="Example1" title="Modbus示例" />
    /// </example>
    public class ModbusTcpNet : NetworkDeviceBase
    {
        ...
        /// <summary>
        /// 获取modbus协议自增的消息号，你可以自定义modbus的消息号的规则，详细参见<see cref="T:ESTCore.Common.ModBus.ModbusTcpNet" />说明，也可以查找<see cref="T:ESTCore.Common.BasicFramework.SoftIncrementCount" />说明。<br />
        /// Get the message number incremented by the modbus protocol. You can customize the rules of the message number of the modbus. For details, please refer to the description of <see cref="T:ESTCore.Common.ModBus.ModbusTcpNet" />, or you can find the description of <see cref="T:ESTCore.Common.BasicFramework.SoftIncrementCount" />
        /// </summary>
        ...
        /// <example>
        /// 此处演示批量读取的示例
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="ReadExample1" title="Read示例" />
        /// </example>
        ...
        /// <example>
        /// 此处演示批量写入的示例
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Modbus\Modbus.cs" region="WriteExample1" title="Write示例" />
        /// </example>
