...
namespace ESTCore.Common
{
    ...
    /// <remarks>
    /// 通常用于<see cref="T:ESTCore.Common.Enthernet.NetComplexServer" />和<see cref="T:ESTCore.Common.Enthernet.NetComplexClient" />之间的通信，以及<see cref="T:ESTCore.Common.Enthernet.NetSimplifyServer" />和<see cref="T:ESTCore.Common.Enthernet.NetSimplifyClient" />通讯
    /// </remarks>
    /// <example>
    /// 使用上等同于int，只是本结构体允许将4字节的int拆分成3部分单独访问
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetHandle.cs" region="NetHandleExample" title="NetHandle示例" />
    /// </example>
