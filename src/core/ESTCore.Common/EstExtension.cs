...
// Type: ESTCore.Common.EstExtension
...
namespace ESTCore.Common
{
    ...
    {
        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ByteToHexString(System.Byte[])" />
        public static string ToHexString(this byte[] InBytes) => SoftBasic.ByteToHexString(InBytes);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ByteToHexString(System.Byte[],System.Char)" />
        public static string ToHexString(this byte[] InBytes, char segment) => SoftBasic.ByteToHexString(InBytes, segment);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ByteToHexString(System.Byte[],System.Char,System.Int32)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.HexStringToBytes(System.String)" />
        public static byte[] ToHexBytes(this string value) => SoftBasic.HexStringToBytes(value);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.BoolOnByteIndex(System.Byte,System.Int32)" />
        public static bool GetBoolOnIndex(this byte value, int offset) => SoftBasic.BoolOnByteIndex(value, offset);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.BoolArrayToByte(System.Boolean[])" />
        public static byte[] ToByteArray(this bool[] array) => SoftBasic.BoolArrayToByte(array);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ByteToBoolArray(System.Byte[],System.Int32)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ByteToBoolArray(System.Byte[])" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ArrayRemoveDouble``1(``0[],System.Int32,System.Int32)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ArrayRemoveBegin``1(``0[],System.Int32)" />
        public static T[] RemoveBegin<T>(this T[] value, int length) => SoftBasic.ArrayRemoveBegin<T>(value, length);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ArrayRemoveLast``1(``0[],System.Int32)" />
        public static T[] RemoveLast<T>(this T[] value, int length) => SoftBasic.ArrayRemoveLast<T>(value, length);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ArraySelectMiddle``1(``0[],System.Int32,System.Int32)" />
        public static T[] SelectMiddle<T>(this T[] value, int index, int length) => SoftBasic.ArraySelectMiddle<T>(value, index, length);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ArraySelectBegin``1(``0[],System.Int32)" />
        public static T[] SelectBegin<T>(this T[] value, int length) => SoftBasic.ArraySelectBegin<T>(value, length);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ArraySelectLast``1(``0[],System.Int32)" />
        public static T[] SelectLast<T>(this T[] value, int length) => SoftBasic.ArraySelectLast<T>(value, length);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.GetValueFromJsonObject``1(Newtonsoft.Json.Linq.JObject,System.String,``0)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.SpliceArray``1(``0[][])" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ArrayFormat``1(``0[])" />
        public static string ToArrayString<T>(this T[] value) => SoftBasic.ArrayFormat<T>(value);

        /// <inheritdoc cref="M:ESTCore.Common.BasicFramework.SoftBasic.ArrayFormat``1(``0,System.String)" />
