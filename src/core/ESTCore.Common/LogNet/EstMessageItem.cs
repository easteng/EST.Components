...
// Type: ESTCore.Common.LogNet.EstMessageItem
...
namespace ESTCore.Common.LogNet
{
    ...
    public class EstMessageItem
    {
        ...
        /// <summary>
        /// 是否取消写入到文件中去，在事件 <see cref="E:ESTCore.Common.LogNet.LogNetBase.BeforeSaveToFile" /> 触发的时候捕获即可设置。<br />
        /// Whether to cancel writing to the file, can be set when the event <see cref="E:ESTCore.Common.LogNet.LogNetBase.BeforeSaveToFile" /> is triggered.
        /// </summary>
