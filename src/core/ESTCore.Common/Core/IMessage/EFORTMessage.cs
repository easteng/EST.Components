...
// Type: ESTCore.Common.Core.IMessage.EFORTMessage
...
namespace ESTCore.Common.Core.IMessage
{
    ...
    public class EFORTMessage : INetMessage
    {
        ...
        public int GetContentLengthByHeadBytes() => (int)BitConverter.ToInt16(this.HeadBytes, 16) - 18;
