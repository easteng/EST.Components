...
// Type: ESTCore.Common.Core.Net.NetworkDeviceBase
...
{
    /// <summary>
    /// 设备交互类的基类，实现了<see cref="T:ESTCore.Common.Core.IReadWriteNet" />接口的基础方法方法，需要使用继承重写来实现字节读写，bool读写操作。<br />
    /// The base class of the device interaction class, which implements the basic methods of the <see cref="T:ESTCore.Common.Core.IReadWriteNet" /> interface,
