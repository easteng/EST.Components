...
// Type: ESTCore.Common.Core.Net.NetworkDoubleBase
...
namespace ESTCore.Common.Core.Net
{
    ...
    public class NetworkDoubleBase : NetworkBase, IDisposable
    {
        ...
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="ByteTransform" title="ByteTransform示例" />
        /// </example>
        ...
        /// <example>
        /// 设置1秒的超时的示例
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="ConnectTimeOutExample" title="ConnectTimeOut示例" />
        /// </example>
        ...
        /// <example>
        /// 设置1秒的接收超时的示例
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="ReceiveTimeOutExample" title="ReceiveTimeOut示例" />
        /// </example>
        ...
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="IpAddressExample" title="IpAddress示例" />
        /// </example>
        ...
        /// <example>
        /// 以下的方式演示了另一种长连接的机制
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="SetPersistentConnectionExample" title="SetPersistentConnection示例" />
        /// </example>
        ...
        ///   <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="Connect1" title="连接设备" />
        ///   如果想知道是否连接成功，请参照下面的代码。
        ///   <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="Connect2" title="判断连接结果" />
        /// </example>
        ...
        /// </summary>
        /// <param name="session">异形客户端对象，查看<seealso cref="T:ESTCore.Common.Core.Net.NetworkAlienClient" />类型创建的客户端</param>
        /// <returns>通常都为成功</returns>
        /// <example>
        ///   简单的创建示例。
        ///   <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="AlienConnect1" title="连接设备" />
        ///   如果想知道是否创建成功。通常都是成功。
        ///   <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="AlienConnect2" title="判断连接结果" />
        /// </example>
        ...
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="ConnectCloseExample" title="关闭连接结果" />
        /// </example>
        ...
        /// <code lang="cs" source="ESTCore.Common_Net45\Profinet\Siemens\SiemensS7Net.cs" region="NetworkDoubleBase Override" title="西门子重连示例" />
        /// </example>
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.AccountCertificate(System.Net.Sockets.Socket)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.InitializationOnConnect(System.Net.Sockets.Socket)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.ExtraOnDisconnect(System.Net.Sockets.Socket)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.CreateSocketAndInitialication" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.GetAvailableSocket" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.ConnectServer" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.ConnectClose" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.ReadFromCoreServer(System.Net.Sockets.Socket,System.Byte[],System.Boolean,System.Boolean)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.ReadFromCoreServer(System.Byte[],System.Boolean)" />
        ...
        /// <summary>
        /// 尝试连接服务器，如果成功，并执行<see cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.InitializationOnConnect(System.Net.Sockets.Socket)" />的初始化方法，并返回最终的结果。<br />
        /// Attempt to connect to the server, if successful, and execute the initialization method of <see cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.InitializationOnConnect(System.Net.Sockets.Socket)" />, and return the final result.
        /// </summary>
        ...
        /// <summary>
        /// 将数据报文发送指定的网络通道上，根据当前指定的<see cref="T:ESTCore.Common.Core.IMessage.INetMessage" />类型，返回一条完整的数据指令<br />
        /// Sends a data message to the specified network channel, and returns a complete data command according to the currently specified <see cref="T:ESTCore.Common.Core.IMessage.INetMessage" /> type
        /// </summary>
        /// <param name="socket">指定的套接字</param>
        /// <param name="send">发送的完整的报文信息</param>
        /// <param name="hasResponseData">是否有等待的数据返回，默认为 true</param>
        /// <param name="usePackHeader">是否需要对命令重新打包，在重写<see cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.PackCommandWithHeader(System.Byte[])" />方法后才会有影响</param>
        ...
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="ReadFromCoreServerExample1" title="ReadFromCoreServer示例" />
        /// </example>
        ...
        /// <summary>
        /// 将数据发送到当前的网络通道中，并从网络通道中接收一个<see cref="T:ESTCore.Common.Core.IMessage.INetMessage" />指定的完整的报文，网络通道将根据<see cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.GetAvailableSocket" />方法自动获取，本方法是线程安全的。<br />
        /// Send data to the current network channel and receive a complete message specified by <see cref="T:ESTCore.Common.Core.IMessage.INetMessage" /> from the network channel.
        /// The network channel will be automatically obtained according to the <see cref="M:ESTCore.Common.Core.Net.NetworkDoubleBase.GetAvailableSocket" /> method This method is thread-safe.
        /// </summary>
        /// <param name="send">发送的完整的报文信息</param>
        /// <param name="hasResponseData">是否有等待的数据返回，默认为 true</param>
        /// <returns>接收的完整的报文信息</returns>
        ...
        /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\Core\NetworkDoubleBase.cs" region="ReadFromCoreServerExample2" title="ReadFromCoreServer示例" />
        /// </example>
