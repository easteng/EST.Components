...
// Type: ESTCore.Common.Core.IByteTransform
...
namespace ESTCore.Common.Core
{
    ...
    public interface IByteTransform
    {
        ...
        /// <summary>
        /// 根据指定的<see cref="P:ESTCore.Common.Core.IByteTransform.DataFormat" />格式，来实例化一个新的对象，除了<see cref="P:ESTCore.Common.Core.IByteTransform.DataFormat" />不同，其他都相同<br />
        /// According to the specified <see cref="P:ESTCore.Common.Core.IByteTransform.DataFormat" /> format, to instantiate a new object, except that <see cref="P:ESTCore.Common.Core.IByteTransform.DataFormat" /> is different, everything else is the same
        /// </summary>
        /// <param name="dataFormat">数据格式</param>
        /// <returns>新的<see cref="T:ESTCore.Common.Core.IByteTransform" />对象</returns>
