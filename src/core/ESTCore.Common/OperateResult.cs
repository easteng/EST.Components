...
// Type: ESTCore.Common.OperateResult
...
namespace ESTCore.Common
{
    ...
    /// </summary>
    /// <remarks>
    /// 当 <see cref="P:ESTCore.Common.OperateResult.IsSuccess" /> 为 True 时，忽略 <see cref="P:ESTCore.Common.OperateResult.Message" /> 及 <see cref="P:ESTCore.Common.OperateResult.ErrorCode" /> 的值
    /// </remarks>
