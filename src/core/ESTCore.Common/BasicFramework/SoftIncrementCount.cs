...
// Type: ESTCore.Common.BasicFramework.SoftIncrementCount
...
namespace ESTCore.Common.BasicFramework
{
    ...
    /// <example>
    /// 先来看看一个简单的应用的
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\BasicFramework\SoftIncrementCountSample.cs" region="Sample1" title="简单示例" />
    /// 再来看看一些复杂的情况
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\BasicFramework\SoftIncrementCountSample.cs" region="Sample2" title="复杂示例" />
    /// 其他一些特殊的设定
    /// <code lang="cs" source="ESTCore.Common_Net45.Test\Documentation\Samples\BasicFramework\SoftIncrementCountSample.cs" region="Sample3" title="其他示例" />
    /// </example>
