...
// Type: ESTCore.Common.MQTT.MqttSyncClientPool
...
namespace ESTCore.Common.MQTT
{
    ...
    /// </summary>
    /// <remarks>
    /// 本连接池用于提供高并发的读写性能，仅对商业授权用户开放。使用起来和<see cref="T:ESTCore.Common.MQTT.MqttSyncClient" />一致，但是更加的高性能，在密集型数据交互时，优势尤为明显。
    /// </remarks>
    public class MqttSyncClientPool
    {
        private MqttConnectionOptions connectionOptions;
        private ESTCore.Common.Algorithms.ConnectPool.ConnectPool<IMqttSyncConnector> mqttConnectPool;
        ...
        public MqttSyncClientPool(MqttConnectionOptions options)
        {
            ...
            this.mqttConnectPool = new ESTCore.Common.Algorithms.ConnectPool.ConnectPool<IMqttSyncConnector>((Func<IMqttSyncConnector>)(() => new IMqttSyncConnector(options)));
        ...
        public MqttSyncClientPool(MqttConnectionOptions options, Action<MqttSyncClient> initialize)
        {
            ...
            if (!Authorization.asdniasnfaksndiqwhawfskhfaiw())
                throw new Exception(StringResources.Language.InsufficientPrivileges);
            this.mqttConnectPool = new ESTCore.Common.Algorithms.ConnectPool.ConnectPool<IMqttSyncConnector>((Func<IMqttSyncConnector>)(() =>
           {
        ...
        /// </summary>
        public ESTCore.Common.Algorithms.ConnectPool.ConnectPool<IMqttSyncConnector> GetMqttSyncConnectPool => this.mqttConnectPool;
        ...
        /// <inheritdoc cref="M:ESTCore.Common.MQTT.MqttSyncClientPool.Read(System.String,System.Byte[],System.Action{System.Int64,System.Int64},System.Action{System.String,System.String},System.Action{System.Int64,System.Int64})" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.MQTT.MqttSyncClientPool.ReadString(System.String,System.String,System.Action{System.Int64,System.Int64},System.Action{System.String,System.String},System.Action{System.Int64,System.Int64})" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.MQTT.MqttSyncClientPool.ReadRpc``1(System.String,System.String)" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.MQTT.MqttSyncClientPool.ReadRpc``1(System.String,System.Object)" />
        public async Task<OperateResult<T>> ReadRpcAsync<T>(
          string topic,
          object payload)
        {
        ...
        /// <inheritdoc cref="M:ESTCore.Common.MQTT.MqttSyncClientPool.ReadRpcApis" />
        ...
        /// <inheritdoc cref="M:ESTCore.Common.MQTT.MqttSyncClientPool.ReadRpcApiLog(System.String)" />
