...
// Type: ESTCore.Common.Instrument.DLT.DLT645
...
namespace ESTCore.Common.Instrument.DLT
{
    ...
    /// 在点对点模式下，需要在打开串口后调用 <see cref="M:ESTCore.Common.Instrument.DLT.DLT645.ReadAddress" /> 方法，数据标识格式为 00-00-00-00，具体参照文档手册。<br />
    ...
    /// In the point-to-point mode, you need to call <see cref="M:ESTCore.Common.Instrument.DLT.DLT645.ReadAddress" /> method after opening the serial port.
    /// the data identification format is 00-00-00-00, refer to the documentation manual for details.
    /// </summary>
    /// <remarks>
    /// 如果一对多的模式，地址可以携带地址域访问，例如 "s=2;00-00-00-00"，主要使用 <see cref="M:ESTCore.Common.Instrument.DLT.DLT645.ReadDouble(System.String,System.UInt16)" /> 方法来读取浮点数，
    /// <see cref="M:ESTCore.Common.Serial.SerialDeviceBase.ReadString(System.String,System.UInt16)" /> 方法来读取字符串
    /// </remarks>
    /// <example>
    ...
    public class DLT645 : SerialDeviceBase
    {
      ...
      (byte) 254
        ...
        /// <inheritdoc cref="M:ESTCore.Common.Instrument.DLT.DLT645.ReadDouble(System.String,System.UInt16)" />
