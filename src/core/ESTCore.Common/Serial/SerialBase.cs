...
// Type: ESTCore.Common.Serial.SerialBase
...
namespace ESTCore.Common.Serial
{
    ...
    {
        /// <inheritdoc cref="F:ESTCore.Common.Core.Net.NetworkDoubleBase.LogMsgFormatBinary" />
        protected bool LogMsgFormatBinary = true;
        private bool disposedValue = false;
        /// <summary>串口交互的核心</summary>
        protected SerialPort sP_ReadData = (System.IO.Ports.SerialPort)null;
